...
const fixture = () => {
  ...
  for (const relative of ['app/soapbox', 'app/styles', 'config/design-component-authority-inventory.json', 'config/component-ownership-manifest.json', 'docs/architecture', 'tailwind.config.js', 'tailwind']) {
