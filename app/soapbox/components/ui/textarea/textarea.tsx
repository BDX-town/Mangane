...
interface ITextarea extends Pick<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'aria-describedby' | 'aria-invalid' | 'aria-label' | 'id' | 'maxLength' | 'onChange' | 'required' | 'disabled' | 'rows' | 'readOnly'> {
